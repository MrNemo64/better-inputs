...
public interface InputProcessListener<I> {
     ...
     * <br><b>Should only be called ones when the {@link InputProcess} is created, calling this method in other moment or
     * more than ones may result in a {@link RuntimeException} depending on the implementation</b>
     * @param onInputReceived
     * @param failInputProcess
     */
    void linkInputProcess(Consumer<I> onInputReceived, Consumer<? extends InputProcessFailureReason> failInputProcess);
