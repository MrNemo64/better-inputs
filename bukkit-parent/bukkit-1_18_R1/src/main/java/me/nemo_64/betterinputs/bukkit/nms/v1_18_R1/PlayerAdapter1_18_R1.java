...
import me.nemo_64.betterinputs.bukkit.nms.v1_18_R1.network.PlayerNetwork1_18_R1;
import me.nemo_64.betterinputs.bukkit.nms.v1_18_R1.util.MinecraftConstant1_18_R1;
...
public final class PlayerAdapter1_18_R1 extends PlayerAdapter {

    private final PlayerNetwork1_18_R1 network;

    private final CraftPlayer bukkit;
    private final ServerPlayer minecraft;

    public PlayerAdapter1_18_R1(PacketManager1_18_R1 packetManager, Player player) {
        super(player.getUniqueId());
        this.bukkit = (CraftPlayer) player;
        this.minecraft = bukkit.getHandle();
        this.network = new PlayerNetwork1_18_R1(packetManager, this);
    }
    ...
    public PlayerNetwork1_18_R1 getNetwork() {
        return network;
    }
    ...
    public int createAnvilMenu(String name, ItemStack itemStack) {
        ...
        AnvilMenu menu = new AnvilMenu(minecraft.nextContainerCounter(), minecraft.getInventory(), MinecraftConstant1_18_R1.BETTER_NULL);
