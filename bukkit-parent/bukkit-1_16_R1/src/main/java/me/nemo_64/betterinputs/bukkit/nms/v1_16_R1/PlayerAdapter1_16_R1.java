...
import me.nemo_64.betterinputs.bukkit.nms.v1_16_R1.network.PlayerNetwork1_16_R1;
import me.nemo_64.betterinputs.bukkit.nms.v1_16_R1.util.MinecraftConstant1_16_R1;
import net.minecraft.server.v1_16_R1.*;

public final class PlayerAdapter1_16_R1 extends PlayerAdapter {

    private final PlayerNetwork1_16_R1 network;

    private final CraftPlayer bukkit;
    private final EntityPlayer minecraft;

    public PlayerAdapter1_16_R1(PacketManager1_16_R1 packetManager, Player player) {
        super(player.getUniqueId());
        this.bukkit = (CraftPlayer) player;
        this.minecraft = bukkit.getHandle();
        this.network = new PlayerNetwork1_16_R1(packetManager, this);
    }
    ...
    public PlayerNetwork1_16_R1 getNetwork() {
        return network;
    }
    ...
    public int createAnvilMenu(String name, ItemStack itemStack) {
        ...
        ContainerAnvil menu = new ContainerAnvil(minecraft.nextContainerCounter(), minecraft.inventory, MinecraftConstant1_16_R1.BETTER_NULL);
