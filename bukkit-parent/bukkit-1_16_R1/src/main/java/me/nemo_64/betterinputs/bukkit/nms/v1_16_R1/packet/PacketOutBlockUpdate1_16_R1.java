...
public final class PacketOutBlockUpdate1_16_R1 extends PacketOutBlockUpdate {
    ...
    public PacketOutBlockUpdate1_16_R1(final PacketPlayOutBlockChange packet) {
        this.packet = packet;
    }

    public PacketOutBlockUpdate1_16_R1(final ArgumentMap map) {
        ...
        accessor.setValue(packet, "position", new BlockPosition(location.getBlockX(), location.getBlockY(), location.getBlockZ()));
        packet.block = state;
    }
