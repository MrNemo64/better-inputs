...
import me.nemo_64.betterinputs.nms.packet.PacketOutBlockUpdate;
...
public final class PacketOutBlockUpdate1_19_R1 extends PacketOutBlockUpdate {

    private final ClientboundBlockUpdatePacket packet;

    public PacketOutBlockUpdate1_19_R1(final ClientboundBlockUpdatePacket packet) {
        this.packet = packet;
    }

    public PacketOutBlockUpdate1_19_R1(final ArgumentMap map) {
