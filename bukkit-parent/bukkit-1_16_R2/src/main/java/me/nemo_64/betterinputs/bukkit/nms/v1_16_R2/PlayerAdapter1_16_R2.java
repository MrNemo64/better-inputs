...
import me.nemo_64.betterinputs.bukkit.nms.v1_16_R2.network.PlayerNetwork1_16_R2;
import me.nemo_64.betterinputs.bukkit.nms.v1_16_R2.util.MinecraftConstant1_16_R2;
import net.minecraft.server.v1_16_R2.*;

public final class PlayerAdapter1_16_R2 extends PlayerAdapter {
    ...
    public PlayerAdapter1_16_R2(PacketManager1_16_R2 packetManager, Player player) {
        super(player.getUniqueId());
        this.bukkit = (CraftPlayer) player;
        this.minecraft = bukkit.getHandle();
        this.network = new PlayerNetwork1_16_R2(packetManager, this);
    }
    ...
    public PlayerNetwork1_16_R2 getNetwork() {
        return network;
    }
    ...
    public int createAnvilMenu(String name, ItemStack itemStack) {
        ...
        ContainerAnvil menu = new ContainerAnvil(minecraft.nextContainerCounter(), minecraft.inventory, MinecraftConstant1_16_R2.BETTER_NULL);
