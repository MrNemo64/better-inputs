...
public final class PacketInSetCommandBlock1_18_R2 extends PacketInSetCommandBlock {

    private final ServerboundSetCommandBlockPacket packet;

    public PacketInSetCommandBlock1_18_R2(final ServerboundSetCommandBlockPacket packet) {
        this.packet = packet;
    }
