...
import me.nemo_64.betterinputs.bukkit.nms.v1_19_R3.network.PlayerNetwork1_19_R3;
import me.nemo_64.betterinputs.bukkit.nms.v1_19_R3.util.MinecraftConstant1_19_R3;
...
public final class PlayerAdapter1_19_R3 extends PlayerAdapter {
    ...
    public PlayerAdapter1_19_R3(PacketManager1_19_R3 packetManager, Player player) {
        super(player.getUniqueId());
        this.bukkit = (CraftPlayer) player;
        this.minecraft = bukkit.getHandle();
        this.network = new PlayerNetwork1_19_R3(packetManager, this);
    }
