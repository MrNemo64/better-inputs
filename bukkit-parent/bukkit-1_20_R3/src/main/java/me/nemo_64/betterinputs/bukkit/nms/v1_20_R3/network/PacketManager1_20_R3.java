package me.nemo_64.betterinputs.bukkit.nms.v1_20_R3.network;
...
import me.nemo_64.betterinputs.bukkit.nms.v1_20_R3.PlayerAdapter1_20_R3;
import me.nemo_64.betterinputs.bukkit.nms.v1_20_R3.VersionHandler1_20_R3;
...
public final class PacketManager1_20_R3 extends PacketManager {
    ...
    public PacketManager1_20_R3(VersionHandler1_20_R3 handler) {
        super(handler);
    }
    ...
    final boolean call(PlayerAdapter1_20_R3 player, Packet<?> nmsPacket) {
