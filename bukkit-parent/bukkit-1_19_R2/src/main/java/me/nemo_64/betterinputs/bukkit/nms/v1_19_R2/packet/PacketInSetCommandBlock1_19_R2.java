...
public final class PacketInSetCommandBlock1_19_R2 extends PacketInSetCommandBlock {

    private final ServerboundSetCommandBlockPacket packet;

    public PacketInSetCommandBlock1_19_R2(final ServerboundSetCommandBlockPacket packet) {
        this.packet = packet;
    }
