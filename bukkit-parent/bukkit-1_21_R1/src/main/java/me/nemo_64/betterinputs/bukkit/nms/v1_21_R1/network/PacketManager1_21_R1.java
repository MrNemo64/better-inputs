...
import me.nemo_64.betterinputs.bukkit.nms.v1_21_R1.PlayerAdapter1_21_R1;
import me.nemo_64.betterinputs.bukkit.nms.v1_21_R1.VersionHandler1_21_R1;
...
public final class PacketManager1_21_R1 extends PacketManager {
    ...
    public PacketManager1_21_R1(VersionHandler1_21_R1 handler) {
        super(handler);
    }
    ...
    final boolean call(PlayerAdapter1_21_R1 player, Packet<?> nmsPacket) {
