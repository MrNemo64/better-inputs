...
import me.nemo_64.betterinputs.bukkit.nms.v1_21_R1.network.PlayerNetwork1_21_R1;
import me.nemo_64.betterinputs.bukkit.nms.v1_21_R1.util.MinecraftConstant1_21_R1;
...
public final class PlayerAdapter1_21_R1 extends PlayerAdapter {
    ...
    public PlayerAdapter1_21_R1(PacketManager1_21_R1 packetManager, Player player) {
        super(player.getUniqueId());
        this.bukkit = (CraftPlayer) player;
        this.minecraft = bukkit.getHandle();
        this.network = new PlayerNetwork1_21_R1(packetManager, this);
    }
    ...
    public int createAnvilMenu(String name, ItemStack itemStack) {
        ...
        AnvilMenu menu = new AnvilMenu(minecraft.nextContainerCounter(), minecraft.getInventory(), MinecraftConstant1_21_R1.BETTER_NULL);
