...
public final class PacketOutBlockUpdate1_20_R2 extends PacketOutBlockUpdate {

    private final ClientboundBlockUpdatePacket packet;

    public PacketOutBlockUpdate1_20_R2(final ClientboundBlockUpdatePacket packet) {
        this.packet = packet;
    }

    public PacketOutBlockUpdate1_20_R2(final ArgumentMap map) {
