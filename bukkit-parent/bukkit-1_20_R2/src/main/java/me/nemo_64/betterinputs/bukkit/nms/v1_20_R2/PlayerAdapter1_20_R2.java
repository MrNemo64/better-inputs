...
import me.nemo_64.betterinputs.bukkit.nms.v1_20_R2.network.PlayerNetwork1_20_R2;
import me.nemo_64.betterinputs.bukkit.nms.v1_20_R2.util.MinecraftConstant1_20_R2;
...
public final class PlayerAdapter1_20_R2 extends PlayerAdapter {
    ...
    public PlayerAdapter1_20_R2(PacketManager1_20_R2 packetManager, Player player) {
        super(player.getUniqueId());
        this.bukkit = (CraftPlayer) player;
        this.minecraft = bukkit.getHandle();
        this.network = new PlayerNetwork1_20_R2(packetManager, this);
    }
    ...
    public int createAnvilMenu(String name, ItemStack itemStack) {
        ...
        AnvilMenu menu = new AnvilMenu(minecraft.nextContainerCounter(), minecraft.getInventory(), MinecraftConstant1_20_R2.BETTER_NULL);
